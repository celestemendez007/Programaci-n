...
print("Consumo del hogar 5 el viernes (día 5):", consumo[4,4])        # Todos los datos de la fila 0
...
print("Promedio de consumo en fines de semana: de sabado ", promedio_fin_semana)
...
'''
El dia con mayor desviación estándar significa que es el día 
con mayor variabilidad en consumo entre los hogares
'''
...
indices_menor_consumo = np.argmin(consumo_total)[:3]
